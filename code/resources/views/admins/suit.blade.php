                            ...
                            <div class="col-lg-10">
                                <div class="box dark">
                                    ...
                                    <div id="div-1" class="body">
                                        <form class="form-horizontal" action="/suit/store" method="post" enctype="multipart/form-data">
                                         @csrf

                                            <div class="form-group">
                                                <label for="text1" class="control-label col-lg-4">Suit Name</label>
                                                <div class="col-lg-8">
                                                <input type="text" id="text1" placeholder="Suit Name" class="form-control" name="suit_name">
                                                </div>
                                                @error("suit_name")
                                            ...
                                            <div class="form-group">
                                                <label for="pass1" class="control-label col-lg-4">Suit size</label>
                                                <div class="col-lg-8">
                                                <input class="form-control" type="text" id="text1" placeholder="suit size" data-placement="top" name="suit_size">
                                                </div>
                                                @error("suit_size")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <!-- /.form-group -->
                                            <div class="form-group">
                                            <label for="limiter" class="control-label col-lg-4">suit color</label>
                                                <div class="col-lg-8">
                                                    <select class="form-control" name="suit_color">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-lg-4">Suit price</label>
                                                <div class="col-lg-8">
                                                <input type="text" id="text2" placeholder="suit price" class="form-control" name="suit_price">
                                                </div>
                                                @error("suit_price")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                <input class="form-control" type="text" id="text1" placeholder="Price" data-placement="top" name="special_price">
                                                </div>
                                                @error("special_price")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                            <label for="text2" class="control-label col-lg-4">suit image</label>
                                            <div class="col-lg-8"><input type="file" name="suit_image"></div>
                                            </div>
                                            <!-- /.form-group -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <textarea id="w3review" name="suit_desc" class="form-control" rows="4" cols="95">  </textarea>
                                                </div>
                                                @error("suit_desc")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                    ...
                                    <table class="table table-striped responsive-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><b>Suit Name</b></td>
                                                <td><b>Suit size</b></td>
                                                <td><b>Suit color</b></td>
                                                <td><b>Suit price</b></td>
                                                <td><b>Spesial price</b></td>
                                                <td><b> is_available</b></td>
                                                <td><b>Suit image</b></td>
                                                <td><b>Delete</b></td>
                                                <td><b>Edit</b></td>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$value->id}}</td>
                                                <td>{{$value->suit_name}}</td>
                                                <td>{{$value->suit_size}}</td>
                                                <td>{{$value->suit_color}}</td>
                                                <td>{{$value->suit_price}}</td>
                                                <td>{{$value->special_price}}</td>
                                                <td>{{$value->is_available}}</td>
                                                <td><img height="80em" width="80em" src='{{asset("images/$value->suit_image")}}'></td>
                                                <td>
                                                    <form method="post" action="/suit/delete/{{$value->id}}">
                                                        @method("DELETE")
                                                        @csrf
                                                ...
                                                <button class="btn btn-primary">
                                                 <a href="/suit/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                                                </td>
                                            </tr>
                                            @endforeach
