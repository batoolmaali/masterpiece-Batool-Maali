...
<div class="col-lg-10">
    <div class="box dark" >
        ...
        <div id="div-1" class="body">
            <form class="form-horizontal"  action="/flowershop/store" method="post" >
            @csrf
...
<div class="col-lg-10">
            ...
            <div class="table-responsive">
                    ...
                    @foreach($x as $value) 
                        ...
                        <td>                  
                            <form method="post" action="/flowershop/delete/{{$value->id}}">
                            @method("DELETE")
                            @csrf
                           ...
                           <td>
                             ...
                             <a href="/flowershop/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                             </td>
                       @endforeach
                    </tbody>    
                </table>
