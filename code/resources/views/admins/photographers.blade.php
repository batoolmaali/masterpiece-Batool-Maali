...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <form class="form-horizontal"  action="/photographers/store" method="post" enctype="multipart/form-data">
            @csrf

                <div class="form-group">
                <label for="text1" class="control-label col-lg-4">photographer Name</label>
                    <div class="col-lg-8">
                    <input type="text" id="text1" placeholder="photographer Name" class="form-control" name="photographer_name">
                    </div>
                ...
                <div class="form-group">
                    ...
                    placeholder="photographer Email"     data-placement="top" name="photographer_email"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="photographer phone" class="form-control" name="photographer_phone">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="photographer Address" class="form-control" name="photographer_address">
                    </div>
                ...
                <option value="no">no</option>
                 ...
                 <div class="form-group">
                  <label for="text" class="control-label col-lg-4">description</label>
                    <div class="col-lg-8">
                    <textarea id="w3review" class="form-control" name="photo_desc" rows="4" cols="95" >  </textarea>
                ...
                <div class="toolbar">
                    ...
                    <thead>
                        <tr>
                            ...
                            <td><b>photographer Address</b></td>
                            <td><b>photographer phone</b></td>
                            <td><b>is available</b></td>
                            <!-- <td><b>desc</b></td> -->
                            <td><b>photographer image</b></td>
                            <td><b>Delete</b></td>
                            <td><b>Edit</b></td>
                        </tr>
                    ...
                    @foreach($x as $value) 
                        <tr>
                            <td>{{$value->id}}</td>
                            <td>{{$value->photographer_name}}</td>
                            <td>{{$value->photographer_email}}</td>
                            <td>{{$value->photographer_address}}</td>
                            <td>{{$value->photographer_phone}}</td>
                            <td>{{$value->is_available}}</td>
                            <!-- <td>{{$value->photo_desc}}</td> -->
                            <td><img height="80em" width="80em" src='{{asset("images/$value->photographer_image")}}'></td>
                       
                        <td>                  
                            <form method="post" action="/photographers/delete/{{$value->id}}">
                            @method("DELETE")
                            @csrf
                           ...
                           <a href="/photographers/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                          </td>
                       @endforeach
                    </tbody>  
              </table>
