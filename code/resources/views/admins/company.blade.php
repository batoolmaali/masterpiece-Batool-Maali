...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <div id="div-1" class="body">
            <form class="form-horizontal" action="/company/store" method="post" >
            @csrf
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Company Name</label>

                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Company Name" class="form-control" name="company_name">
                    </div>
                    @error("company_name")
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-lg-4">Company Email</label>

                    <div class="col-lg-8">
                        <input class="form-control" type="Email" id="text1"
                        placeholder="Company Email"  data-placement="top" name="company_email"/>
                    </div>
                    @error("company_email")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Company phone" class="form-control" name="company_phone">
                    </div>
                    @error("company_phone")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    <label class="control-label col-lg-4">Company Address</label>

                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Company Address" class="form-control" name="company_address">
                    </div>
            ...
            <div class="table-responsive">
             ...
             <table class="table table-striped responsive-table">
                    ...
                    @foreach($x as $value) 
                        ...
                        <td>
                            <form method="post" action="/company/delete/{{$value->id}}">
                            @method("DELETE")
                            @csrf
                   ...
                   <button class="btn btn-primary">
                    <a href="/company/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                </td>
                       @endforeach
