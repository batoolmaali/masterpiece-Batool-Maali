                            ...
                            <div class="col-lg-10">
                                <div class="box dark">
                                    ...
                                    <div id="div-1" class="body">
                                        <form class="form-horizontal" action="/Tourist_destinations/store" method="post" enctype="multipart/form-data">
                                            @csrf

                                            <div class="form-group">
                                                <label for="text1" class="control-label col-lg-4"> City Name</label>
                                                <div class="col-lg-8">
                                                <input type="text" id="text1" placeholder=" City Name" class="form-control" name="city_name">
                                                </div>
                                                @error("city_name")
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                 <input class="form-control" type="text" id="text1" placeholder="Price" data-placement="top" name="price">
                                                </div>
                                                @error("price")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                <input class="form-control" type="text" id="text1" placeholder="max_pacenger_count" data-placement="top" name="max_pacenger_count">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                <input class="form-control" type="text" id="text1" placeholder="current_pacenger_count	" data-placement="top" name="current_pacenger_count">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label for="text" class="control-label col-lg-4">number of days</label>
                                                <div class="col-lg-8">
                                                <input class="form-control" type="text" id="text1" placeholder="number of days	" data-placement="top" name="number_of_days">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <textarea id="w3review" name="city_desc"  class="form-control" rows="4" cols="95">  </textarea>
                                                </div>
                                                @error("city_desc")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                    ...
                                    <table class="table table-striped responsive-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$value->max_pacenger_count}}</td>
                                                <td>{{$value->current_pacenger_count}}</td>
                                                
                                               
                                                <td>{{$value->is_available}}</td>
                                                <td><img height="80em" width="80em" src='{{asset("images/$value->city_image")}}'></td>
                                                <td>
                                                    <form method="post" action="/Tourist_destinations/delete/{{$value->id}}">
                                                        @method("DELETE")
                                                        @csrf
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/Tourist_destinations/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
