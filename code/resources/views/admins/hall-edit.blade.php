...
<div class="col-lg-10">
    <div class="box dark" >
        ...
        <div id="div-1" class="body">
               <form class="form-horizontal" action="/hall/update/{{$hall->id}}" method="post" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="form-group">
                <label for="text1" class="control-label col-lg-4">Hall Name</label>
                 <div class="col-lg-8">
                  <input type="text" id="text1" placeholder="Hall Name" class="form-control" name="hall_name"  value="{{$hall->hall_name}}">
                    </div>
                    @error("hall_name")
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-lg-4">Hall address</label>
                     ...
                     <input class="form-control" type="text" id="text1"
                        placeholder="Hall address"  data-placement="top" name="hall_address" value="{{$hall->hall_address}}">
                    </div>
                    @error("hall_address")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Hall price" class="form-control"  name="hall_price" value="{{$hall->hall_price}}">
                    </div>
                    @error("hall_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="col-lg-8">
                <input class="form-control" type="text" id="text1"
                  placeholder="Price"   data-placement="top" name="special_price" value="{{$hall->special_price}}">
                    </div>
                    @error("special_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="persons number" class="form-control" name="persons_number" value="{{$hall->persons_number}}">
                    </div>
                ...
                <div class="col-lg-8">
                 <select data-placeholder="Choose a Country..." class="form-control chzn-select" tabindex="2" name="is_available" value="{{$hall->is_available}}">
                ...
                <!-- /.form-group -->
                    ...
                    <div class="col-lg-8">
                    <textarea id="w3review" class="form-control" name="photo_desc" rows="4" cols="95"  placeholder="write something" value="{{$hall->hall_desc}}"> {{$hall->hall_desc}} </textarea>
                    </div>
                    @error("hall_desc")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                  <select class="form-control" name="hall_type" value="{{$hall->hall_type}}">
