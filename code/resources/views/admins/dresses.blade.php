...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <form class="form-horizontal" action="/dresses/store" method="post" enctype="multipart/form-data">
            @csrf

                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Dress Name</label>

                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Dress Name" class="form-control" name="dress_name">
                    </div>
                    @error("dress_name")
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-lg-4">Dress size</label>

                    <div class="col-lg-8">
                        <input class="form-control" type="text" id="text1"
                        placeholder="Dress size"  data-placement="top" name="dress_size">
                    </div>
                    @error("dress_size")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                <label for="limiter" class="control-label col-lg-4">Dress color</label>

               <div class="col-lg-8">
               <select class="form-control" name="dress_color">
               ...
               <option>Nude</option>
                ...
                <!-- /.form-group -->  
                <div class="form-group">
                    <label class="control-label col-lg-4">Dress price</label>

                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Dress price" class="form-control" name="dress_price">
                    </div>
                    @error("dress_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    <label for="text2" class="control-label col-lg-4">Dress image</label>

                    <div class="col-lg-8"><input type="file" name="dress_image"></div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
               <label class="control-label col-lg-4">is available</label>
                ...
                <option value="no">no</option>
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="w3review" name="dress_desc" class="form-control" rows="4" cols="95">  </textarea>
                    </div>
                    @error("dress_desc")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div id="stripedTable" class="body collapse in">
                   <div class="col-lg-12">
                    ...
                    <thead>
                        <tr>
                            <td><b>id</b></td>
                            <td><b>Dress Name</b></td>
                            <td><b>Dress size</b></td>
                            <td><b>Dress color</b></td>
                            <td><b>Dress price</b></td>
                            <td><b>Special price</b></td>
                            <td><b> is_available</b></td>
                            <td><b>Dress image</b></td>
                            <td><b>Delete</b></td>
                            <td><b>Edit</b></td>
                        </tr>
                    ...
                    <tr>
                            ...
                            <td>{{$value->dress_size}}</td>
                            <td>{{$value->dress_color}}</td>
                            <td>{{$value->dress_price}}</td>
                            <td>{{$value->special_price}}</td>
                            <td>{{$value->is_available}}</td>
                            <td><img height="80em" width="80em" src='{{asset("images/$value->dress_image")}}'></td>
                            <td>
                            <form method="post" action="/dresses/delete/{{$value->id}}">
                            @method("DELETE")
                            @csrf
                   ...
                   <button class="btn btn-primary">
                    <a href="/dresses/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                </td>
                        </tr>
                        @endforeach
