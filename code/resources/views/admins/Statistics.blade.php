            ...
            <div class="media user-media bg-dark dker">
                ...
                <div class="user-wrapper bg-dark">
                    ...
                    <div class="media-body">
                        <h5 class="media-heading">&nbsp;&nbsp;Administrator: {{ Auth::user()->role }} {{ Auth::user()->name }} </h5>
                        <ul class="list-unstyled user-info">

                            <li>&nbsp;&nbsp;Last Access : {{ Auth::user()->created_at->toDayDateTimeString()}}
            ...
            <div id="stripedTable" class="body collapse in">
                <table class="table table-striped responsive-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>all order dresses</td>
                            <td>{{$dress}}</td>
                            </tr>
                        <tr>
                            <td>all order  flowers</td>
                            <td>{{$flower}}</td>
                            </tr>
                        <tr>
                            <td>all order  halls</td>
                            <td>{{$hall}}</td>

                            </tr>
                        <tr>
                            <td>all order  suits</td>
                            <td>{{$suit}}</td>
                            </tr>
                        <tr>
                            <td>all order  cities</td>
                            <td>{{$city}}</td>
                            </tr>
                        <tr>
                            <td>all order photographers</td>
                            <td>{{$Photographer}}</td>
                           </tr>
                        <tr>
