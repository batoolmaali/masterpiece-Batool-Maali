...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <form class="form-horizontal" action="/tourism-offices/update/{{$office->id}}" method="post" >
            @csrf
            @method("PUT")
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Toursim Office Name" class="form-control"
                         name="office_name"  value="{{$office->office_name}}">
                    </div>
                    @error("office_name")
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="text1"
                     data-placement="top"  placeholder="Toursim Office Email" name="office_email" value="{{$office->office_email}}"/>
                    </div>
                    @error("office_email")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Toursim Office Phone" class="form-control" name="office_phone" value="{{$office->office_phone}}">
                    </div>
                    @error("office_phone")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Toursim Office Address" class="form-control"  name="office_address" value="{{$office->office_address}}">
                    </div>
