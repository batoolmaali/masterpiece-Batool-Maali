              ...
              <nav style="padding: 8px;">
                 <a href="javascript:;" class="btn btn-default btn-sm collapse-box">
                  ...
                  <a href="javascript:;" class="btn btn-danger btn-sm close-box">
                   ...
                   <form class="form-horizontal" action="/flower/store" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Flower Name</label>
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Flower Name" class="form-control" name="flower_name">
                    </div>
                    @error("flower_name")
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-lg-4">Flower color</label>
                    <div class="col-lg-8">
                    <input class="form-control" type="text" id="text1"
                    placeholder="Flower color"   data-placement="top" name="flower_color"/>
                    </div>
                    @error("flower_color")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-lg-4">Flower price</label>

                    <div class="col-lg-8">
                    <input class="form-control" type="text" id="text2" placeholder="Flower price" name="flower_price"/>
                    </div>
                    @error("flower_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                   ...
                   <div class="form-group">
                    ...
                    @enderror
                     ...
                     <!-- /.form-group -->
                     <div class="form-group">
                    <label class="control-label col-lg-4">Flower Type</label>
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Flower Type" class="form-control" name="flower_type">
                    </div>
                    @error("flower_type")
                     <p style="color:red;">{{$message}}</p>
                    @enderror
                    ...
                    <!-- /.form-group -->
                    <div class="form-group">
                    <label for="text2" class="control-label col-lg-4">Flower image</label>
                    <div class="col-lg-8"><input type="file" name="flower_image"></div>
                    </div>
                    <!-- /.form-group -->
                ...
                <!-- /.form-group -->
                    ...
                    <div class="col-lg-8">
                    <textarea id="w3review" name="flower_desc" class="form-control" rows="4" cols="95">  </textarea>
                    </div>
                    @error("flower_desc")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                   ...
                   <!-- /.form-group -->
                    <div class="form-group">
                    <label for="limiter" class="control-label col-lg-4">Flower shop</label>
                    <div class="col-lg-8">
                ...
                <div class="toolbar">
                    ...
                    <thead>
                        <tr>
                            ...
                            <td><b>Flower price</b></td>
                            <td><b>Flower Type</b></td>
                            <td><b>Special price</b></td>
                            <td><b>available</b></td>
                            <td><b>Flower image</b></td>
                            <td><b>Delete</b></td>
                            <td><b>Edit</b></td>
                        </tr>
                    ...
                    <tr>
                            ...
                            <td>{{$value->flower_color}}</td>
                            <td>{{$value->flower_price}}</td>
                            <td>{{$value->flower_type}}</td>
                            <td>{{$value->special_price}}</td>
                            <td>{{$value->is_available}}</td>
                            <td><img height="80em" width="80em" src='{{asset("images/$value->flower_image")}}'></td>
                            <td>
                            <form method="post" action="/flower/delete/{{$value->id}}">
                            @method("DELETE")
                            @csrf
                           ...
                           <a href="/flower/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                           </td>
                        </tr>
                        @endforeach
                       </tbody>   
