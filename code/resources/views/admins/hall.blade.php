...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <form class="form-horizontal" action="/hall/store" method="post" enctype="multipart/form-data">
            @csrf

                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Hall Name</label>
                    <div class="col-lg-8">
                    <input type="text" id="text1" placeholder="Hall Name" class="form-control" name="hall_name">
                    </div>
                    @error("hall_name")
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-lg-4">Hall address</label>
                    <div class="col-lg-8">
                    <input class="form-control" type="text" id="text1"
                        placeholder="Hall address"  data-placement="top" name="hall_address">
                    </div>
                    @error("hall_address")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    <label class="control-label col-lg-4">Hall price</label>
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Hall price" class="form-control"  name="hall_price">
                    </div>
                    @error("hall_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input class="form-control" type="text" id="text1"
                        placeholder="Price"   data-placement="top" name="special_price">
                    </div>
                    @error("special_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                   ...
                   <!-- /.form-group -->
                <div class="form-group">
                    <label class="control-label col-lg-4">persons number</label>
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="persons number" class="form-control" name="persons_number">
                    </div>
                ...
                <div class="form-group">
                 <label class="control-label col-lg-4">is available</label>
                  <div class="col-lg-8">
                 <select data-placeholder="Choose a Country..." class="form-control chzn-select" tabindex="2" name="is_available">
                ...
                <div class="form-group">
                <label for="limiter" class="control-label col-lg-4">Hall company</label>
                <div class="col-lg-8" >
                ...
                <div class="form-group">
                <label for="text2" class="control-label col-lg-4">Hall image</label>
                <div class="col-lg-8"><input type="file" name="hall_image"></div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                    <label for="text" class="control-label col-lg-4">description</label>
                    <div class="col-lg-8">
                    <textarea id="w3review" class="form-control" name="hall_desc" rows="4" cols="95">  </textarea>
                    </div>
                    @error("hall_desc")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    <label for="limiter" class="control-label col-lg-4">Hall type</label>
                    <div class="col-lg-8">
             ...
             <table class="table table-striped responsive-table">
                    <thead>
                        <tr>
                            <td><b>id</b></td>
                            <td><b>Hall Name</b></td>
                            <td><b>Hall Address</b></td>
                            <td><b>Hall price</b></td>
                            <td><b>Hall  special price</b></td>
                            <td><b>Persons number</b></td>
                            <td><b>available</b></td>
                            <td><b>Hall type</b></td>
                           
                            <td><b>Hall image</b></td>
                            <td><b>Delete</b></td>
                            <td><b>Edit</b></td>
                        </tr>
                    ...
                    <tr>
                            ...
                            <td>{{$value->hall_address}}</td>
                            <td>{{$value->hall_price}}</td>
                            <td>{{$value->special_price}}</td>
                            <td>{{$value->persons_number}}</td>
                            <td>{{$value->is_available}}</td>
                            <!-- <td>{{$value->company_id}}</td> -->
                            <td>{{$value->hall_type}}</td>
                            
                            <td><img height="80em" width="80em" src='{{asset("images/$value->hall_image")}}'></td>
                            <td>
                            <form method="post" action="/hall/delete/{{$value->id}}">
                            @method("DELETE")
                            @csrf
                           ...
                           <a href="/hall/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                          </td>
                          </tr>
                           @endforeach
                    </tbody>   
