                            ...
                            <div class="col-lg-10">
                                <div class="box dark">
                                    ...
                                    <div id="div-1" class="body">
                                        <form class="form-horizontal" action="/admin/store" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="text1" class="control-label col-lg-4">Admin Name</label>

                                                <div class="col-lg-8">
                                                    <input type="text" id="text1" placeholder="admin name" class="form-control" name="name">
                                                </div>
                                                @error("name")
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" id="text2" placeholder="admin email" class="form-control" placeholder="Admin email" name="email">
                                                </div>
                                                @error("email")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                    ...
                                    <table class="table table-striped responsive-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$value->name}}</td>
                                                <td>{{$value->email}}</td>
                                                <td><img height="80em" width="80em" src='{{asset("images/$value->admin_image")}}'></td>
                                                <td>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary">
                                                        <a href="/admin/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
