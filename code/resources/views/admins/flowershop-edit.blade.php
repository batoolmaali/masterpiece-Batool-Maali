...
<div class="col-lg-10">
    <div class="box dark" >
        ...
        <div id="div-1" class="body">
            <form class="form-horizontal"  action="/flowershop/update/{{$shop->id}}" method="post" >
            @csrf
            @method("PUT")
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="shop Name" class="form-control" name="shop_name" value="{{$shop->shop_name}}">
                    </div>
                    @error("shop_name")
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        placeholder="shop email" data-placement="top"name="shop_email" value="{{$shop->shop_email}}"/>
                    </div>
                    @error("shop_email")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="shop phone" class="form-control" name="shop_phone" value="{{$shop->shop_phone}}">
                    </div>
                    @error("shop_phone")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="shop address" class="form-control" name="shop_address" value="{{$shop->shop_address}}">
                    </div>
                    @error("shop_address")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
