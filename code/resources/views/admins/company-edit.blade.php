...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <header>
            ...
            <form class="form-horizontal" action="/company/update/{{$company->id}}" method="post" >
            @csrf
            @method("PUT")
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Company Name" class="form-control" name="company_name" value="{{$company->company_name}}">
                    </div>
                    @error("company_name")
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        placeholder="Company Email"  data-placement="top" name="company_email" value="{{$company->company_email}}"/>
                    </div>
                    @error("company_email")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Company phone" class="form-control" name="company_phone" value="{{$company->company_phone}}">
                    </div>
                    @error("company_phone")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Company Address" class="form-control" name="company_address" value="{{$company->company_address}}">
                    </div>
