                            ...
                            <div class="col-lg-10">
                                <div class="box dark">
                                    ...
                                    <div id="div-1" class="body">
                                        <form class="form-horizontal" action="/shopsuit/update/{{$shop1->id}}" method="post">
                                            @csrf
                                            @method("PUT")
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="text" placeholder="shop email" data-placement="top" name="shop_email" value="{{$shop1->shop_email}}" />
                                                </div>
                                                @error("shop_email")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
