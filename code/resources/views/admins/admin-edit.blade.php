...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
                ...
                <div class="container-fluid">
                    ...
                    <div class="topnav">
                        ...
                        <div class="btn-group">
                            ...
                            <a data-placement="bottom" class="btn btn-default btn-sm" href="/pro"><i class="fas fa-home fa-1x" aria-hidden="true"></i>
                            </a>
                        </div>
                        <div class="btn-group">
            ...
            <header class="head">
                <div class="search-bar">
                    <form class="main-search" action="">
                        ...
                        <input type="text" class="form-control" placeholder="Live ">                            <span class="input-group-btn">
        ...
        <div id="left">
            ...
            <!-- #menu -->
            <ul id="menu" class="bg-dark dk" !important>
                            ...
                            <div class="col-lg-10">
                                <div class="box dark">
                                    ...
                                    <div id="div-1" class="body">
                                        <form class="form-horizontal" action="/admin/update/{{$admin->id}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method("PUT")
                                            <div class="form-group">
                                                <label for="text1" class="control-label col-lg-4">Admin Name</label>

                                                <div class="col-lg-8">
                                                    <input type="text" id="text1" placeholder="admin name" class="form-control" name="name" value="{{$admin->name}}">
                                                </div>
                                                @error("name")
                                            ...
                                            <div class="form-group">
                                                <label for="pass1" class="control-label col-lg-4">Admin Password</label>

                                                <div class="col-lg-8">
                                                    <input class="form-control" type="password" id="pass1" data-original-title="Please use your secure password" placeholder="admin password" data-placement="top" name="password">
                                                </div>
                                                @error("password")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-lg-4">Admin Email</label>

                                                <div class="col-lg-8">
                                                    <input type="text" id="text2" placeholder="admin email" class="form-control" placeholder="Admin email" name="email" value="{{$admin->email}}">
                                                </div>
                                                @error("email")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                <label for="text2" class="control-label col-lg-4">Admin image</label>

                                                <div class="col-lg-8"><input type="file" name="admin_image"></div>
                                                @error("admin_image")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="limiter" class="control-label col-lg-4">Admin role</label>
