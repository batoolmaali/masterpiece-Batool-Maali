...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <form class="form-horizontal" action="/flower/update/{{$flower->id}}" method="post" enctype="multipart/form-data">
            @csrf
            @method("PUT")
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Flower Name" class="form-control" name="flower_name" value="{{$flower->flower_name}}">
                    </div>
                    @error("flower_name")
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-lg-4">Flower color</label>
                     <div class="col-lg-8">
                        ...
                        placeholder="Flower color"   data-placement="top" name="flower_color" value="{{$flower->flower_color}}"/>
                    </div>
                    @error("flower_color")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input class="form-control" type="text" id="text2" placeholder="Flower price" name="flower_price" value="{{$flower->flower_price}}"/>
                    </div>
                    @error("flower_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" type="text" id="text1"
                        placeholder="Price"   data-placement="top" name="special_price" value="{{$flower->special_price}}">
                    </div>
                    @error("special_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Flower Type" class="form-control" name="flower_type" value="{{$flower->flower_type}}">
                    </div>
                    @error("flower_type")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <label class="control-label col-lg-4">is available</label>
                   ...
                   <div class="col-lg-8">
                   <select data-placeholder="Choose a Country..." class="form-control chzn-select" tabindex="2" name="is_available" value="{{$flower->is_available}}">
                  ...
                  <!-- /.form-group -->
                    ...
                    <div class="col-lg-8">
                    <textarea id="w3review"  class="form-control" name="flower_desc" rows="4" cols="95" value="{{$flower->flower_desc}}"> {{$flower->flower_desc}} </textarea>
                    </div>
                    @error("flower_desc")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
