                            ...
                            <div class="col-lg-10">
                                <div class="box dark">
                                    ...
                                    <div id="div-1" class="body">
                                        <form class="form-horizontal" action="/suit/update/{{$suit->id}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method("PUT")
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" id="text1" placeholder="suit Name" class="form-control" name="suit_name" value="{{$suit->suit_name}}">
                                                </div>
                                                @error("suit_name")
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="text1" placeholder="suit size" data-placement="top" name="suit_size" value="{{$suit->suit_size}}">
                                                </div>
                                                @error("suit_size")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" name="suit_color" value="{{$suit->suit_color}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                 <input type="text" id="text2" placeholder="suit price" class="form-control" name="suit_price" value="{{$suit->suit_price}}">
                                                </div>
                                                @error("suit_price")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                 <input class="form-control" type="text" id="text1" placeholder="Price" data-placement="top" name="special_price" value="{{$suit->special_price}}">
                                                </div>
                                                @error("special_price")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <select data-placeholder="Choose a Country..." class="form-control chzn-select" tabindex="2" name="is_available" value="{{$suit->is_available}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                <textarea id="w3review" class="form-control" name="suit_desc" rows="4" cols="95" value="{{$suit->suit_desc}}">{{$suit->suit_desc}}  </textarea>
                                                </div>
                                                @error("suit_desc")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
