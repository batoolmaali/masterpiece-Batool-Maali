...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <form class="form-horizontal" action="/dresses/update/{{$dress->id}}" method="post" enctype="multipart/form-data">
            @csrf
            @method("PUT")
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Dress Name" class="form-control" name="dress_name" value="{{$dress->dress_name}}">
                    </div>
                    @error("dress_name")
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        placeholder="Dress size"  data-placement="top" name="dress_size"  value="{{$dress->dress_size}}">
                    </div>
                    @error("dress_size")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                <select class="form-control" name="dress_color"  value="{{$dress->dress_color}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <input type="text" id="text2" placeholder="Dress price" class="form-control" name="dress_price"  value="{{$dress->dress_price}}">
                    </div>
                    @error("dress_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" type="text" id="text1"
                        placeholder="Price"   data-placement="top" name="special_price" value="{{$dress->special_price}}">
                    </div>
                    @error("special_price")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                ...
                <div class="col-lg-8">
                <select data-placeholder="Choose a Country..." class="form-control chzn-select" tabindex="2" name="is_available"  value="{{$dress->is_available}}">
                ...
                <option value="no">no</option>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-lg-8">
                    <textarea id="w3review" class="form-control" name="dress_desc" rows="4" cols="95"  value="{{$dress->dress_desc}}">{{$dress->dress_desc}}  </textarea>
                    </div>
                    @error("dress_desc")
                    <p style="color:red;">{{$message}}</p>
                    @enderror
