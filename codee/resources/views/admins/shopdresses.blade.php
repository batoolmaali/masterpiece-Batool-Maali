...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        ...
        <form class="form-horizontal"  action="/shopdresses/store" method="post" >
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        placeholder="shop email" data-placement="top"name="shop_email"/>
                    </div>
                    @error("shop_email")
                    <p style="color:red;">{{$message}}</p>
                    @enderror 
            ...
            <table class="table table-striped responsive-table">
                    ...
                    @foreach($y as $value) 
                        ...
                        <td>                  
                            <form method="post" action="/shopdresses/delete/{{$value->id}}">
                            @method("DELETE")
                            @csrf
                           ...
                           <td>
                            <button class="btn btn-primary">
                             <a href="/shopdresses/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                            </td>
                       @endforeach
                        </tr>
                    </tbody>               
