                            ...
                            <div class="col-lg-10">
                                <div class="box dark">
                                    ...
                                    <div id="div-1" class="body">
                                        <form class="form-horizontal" action="/shopsuit/store" method="post">
                                            @csrf
                                            <div class="form-group">
                                                <label for="text1" class="control-label col-lg-4">shop Name</label>

                                                <div class="col-lg-8">
                                                    <input type="text" id="text1" placeholder="shop Name" class="form-control" name="shop_name">
                                                </div>
                                                @error("shop_name")
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="text" placeholder="shop email" data-placement="top" name="shop_email" />
                                                </div>
                                                @error("shop_email")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" id="text2" placeholder="shop phone" class="form-control" name="shop_phone">
                                                </div>
                                                @error("shop_phone")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" id="text2" placeholder="shop address" class="form-control" name="shop_address">
                                                </div>
                                                @error("shop_address")
                                                <p style="color:red;">{{$message}}</p>
                                                @enderror
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$value->shop_phone}}</td>
                                            <td>{{$value->shop_address}}</td>


                                            <td>
                                                <form method="post" action="/shopsuit/delete/{{$value->id}}">
                                                    @method("DELETE")
                                                    @csrf
                                            ...
                                            <td>
                                                <button class="btn btn-primary">
                                                    <a href="/shopsuit/edit/{{$value->id}}" style="text-decoration:none; color:white;">Edit</a></button>
                                            </td>
                                            @endforeach
                                        </tr>
                                    </tbody>
