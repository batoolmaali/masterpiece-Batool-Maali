...
<!DOCTYPE html>
<html lang="zxx">
  <!-- Mirrored from preview.colorlib.com/theme/weddingdreams/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Dec 2020 13:06:35 GMT -->
  <head>
    <meta charset="UTF-8" />
        ...
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="counter__item">
              <img src="{{asset('theme/img/icon/ci-1.png')}}" alt="" />
              <!-- <h2 class="counter_num"></h2> -->
              <p>Photos</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="counter__item">
              <img src="{{asset('theme/img/icon/ci-2.png')}}" alt="" />
              <!-- <h2 class="counter_num"></h2> -->
              <p>Happy Couple</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="counter__item">
              <img src="{{asset('theme/img/icon/ci-3.png')}}" alt="" />
              <!-- <h2 class="counter_num"></h2> -->
              <p>Joast</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="counter__item">
              <img src="{{asset('theme/img/icon/ci-4.png')}}" alt="" />
              <!-- <h2 class="counter_num"></h2> -->
              <p>Dress Cakes</p>
            </div>
          </div>
            ...
            <div class="request__form">
              <div class="section-title">
                ...
                <p>
                  ...
                  If you do not have an account on our site, please fill in our form.
                </p>
              </div>
              <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 px-2">
                    <input type="text" placeholder="Name" name="name" class="form-control @error('name') is-invalid @enderror"  value="{{ old('name') }}"  autocomplete="name" autofocus>
                    @error('name')
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 px-2">
                    <input type="email" placeholder="Email"name="email" class="form-control @error('email') is-invalid @enderror"  value="{{ old('email') }}" autocomplete="email"/>
                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 px-2">
                    <input type="password" id="password-confirm" placeholder="repeate password"  name="password_confirmation"  autocomplete="new-password"/>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 px-2" class="form-control @error('phone') is-invalid @enderror">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 px-2">
                    <input style="padding-top: 10px" type="file" placeholder="image" name="image" />
                  </div>
                 
                 
                  <div class="col-lg-12 px-2 text-center">
                  
                    <button type="submit" class="site-btn" style="background-color:#767b67">
                    Register
                    </button>
                  </div>
                </div>
...
<footer>
            <div class="container">
                ...
                <div class="col-sm-12 col-md-3 item" >
                    ...
                    <div class="col-sm-12 col-md-3 item" >
                        <h4 class="eltdf-iwt-title" style="color: #ffffff;text-transform: uppercase;font-family:Cormorant Garamond,serif; font-size: 24px;text-align:left;letter-spacing: .15em;font-weight: 400">Photograghers</h4>
                        <ul>
                            <li class="eltdf-iwt-subtitle" style="color: #ffffff;text-transform: uppercase;font-family:Cormorant Garamond,serif;text-align:left;font-style: italic;font-size: 18px;font-weight: 400" >Wedding</a></li>
                            <li class="eltdf-iwt-subtitle" style="color: #ffffff;text-transform: uppercase;text-align:left; font-size: 12px;margin-top:5%;margin: 19px 2px 0;font-family: Muli,sans-serif;font-weight: 300">Excepteur sint occaecat cupidatat non proident, sunt in culpa</a></li>
    ...
    <script
      ...
      data-cf-beacon='{"rayId":"604994d6bee7ac0d","version":"2020.12.1","si":10}'
    ></script>
  </body>

  <!-- Mirrored from preview.colorlib.com/theme/weddingdreams/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Dec 2020 13:06:50 GMT -->
</html>
