...
<form >
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label"><b> {{ Auth::user()->name }}</b></label>
    <div id="emailHelp" class="form-text">Thank you for your message. It has been sent.</div>

  </div>
  <div class="mb-3">
  </div>

  <button type="submit" class="site-btn" style="background-color:#767b67"><a href="/contact us" style="color:white">back</a></button>
</div>
</div>
</div>
</div>
